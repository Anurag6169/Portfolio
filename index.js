...
app.get("/portfolio-details2",(req,res)=>{
    res.render("portfolio-details2");
})

app.get("/portfolio-details3",(req,res)=>{
    res.render("portfolio-details3");
})
...
app.post('/contact',(req,res)=>{
    ...
    const receiverClient = "anuragsharma6100@gmail.com";
